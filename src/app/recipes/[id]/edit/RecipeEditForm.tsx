  ...
  return recipe?.user.name === auth.name ? (
    <div className="w-full">
      ...
      >
        ...
        <div
          className={`
        fixed bottom-0 bg-white bg-opacity-75 backdrop-blur-xl md:border md:rounded-xl border-t border-gray-200 max-w-4xl
        h-16 w-full
        md:mb-2 p-2 flex justify-between z-10`}
        >
          <button
            type="button"
            onClick={() => router.back()}
