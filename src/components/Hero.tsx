      ...
      <div className="fixed top-0 w-screen h-full">
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <div
              className={`lg:text-2xl text-base font-thin text-gray-800 text-center p-5`}
            >
            ...
            <Link
              ...
              lg:h-36 lg:w-36 h-32 w-32 flex items-center justify-center shadow
              transition-all duration-500 cursor-pointer
              active:scale-95 animate-fade-in-2s z-10`}
            >
              <p className="text-white lg:text-2xl text-lg font-semibold select-none">
                Get started
              </p>
            </Link>
            <Image
              src={riceImage}
              alt="rice"
              className="lg:-translate-y-60 -translate-y-52 opacity-60"
            />
          </div>
        </div>
        <Footer />
